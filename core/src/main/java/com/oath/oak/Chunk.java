        ...
        while (curr != NONE) {
            ...
            // if keys are equal - we've found the item
                ...
                if (valueSlice == null) {
                    ...
                    return new LookUp(null, valueReference, curr, version);
                }
                ...
                return new LookUp(valueSlice, valueReference, curr, version);
            }
        ...
        while (true) {
            ...
            if (entriesToCopy > 0) {
                for (int i = 0; i < entriesToCopy; ++i) {
                    ...
                    // copy both the key and the value references anf the value's version => 5 integers via array copy
