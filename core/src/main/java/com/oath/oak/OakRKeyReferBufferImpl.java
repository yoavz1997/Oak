...
public class OakRKeyReferBufferImpl implements OakRBuffer {
    ...
    OakRKeyReferBufferImpl(
            int blockID, int keyPosition, int keyLength, MemoryManager memoryManager) {
    ...
    OakRKeyReferBufferImpl(MemoryManager memoryManager) {
        this.memoryManager = memoryManager;
    }
